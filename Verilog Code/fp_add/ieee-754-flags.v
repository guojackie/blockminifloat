...
parameter INTn = 8; // Size of integer needed to be rounded 
...
parameter roundTowardZero     = 1;
parameter roundTowardPositive = 2;
parameter roundTowardNegative = 3;
parameter roundTiesToAway     = 4;
parameter NRAS                = roundTiesToAway+1;
                         
parameter INVALID             = 0;
parameter DIVIDEBYZERO        = 1;
parameter OVERFLOW            = 2;
parameter UNDERFLOW           = 3;
parameter INEXACT             = 4;
parameter NEXCEPTIONS     = INEXACT+1;